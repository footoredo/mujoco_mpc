...
namespace mjpc
{
  namespace panda
  {
                                      ...
                                      double *residual) const
    {
      ...
      double *y_box_vel = SensorByName(model, data, "y_box_vel");
      ...
      double *r_box_vel = SensorByName(model, data, "r_box_vel");
      ...
      double *b_box_vel = SensorByName(model, data, "b_box_vel");
