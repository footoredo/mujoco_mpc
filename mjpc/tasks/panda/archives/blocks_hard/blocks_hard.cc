...
#include "mjpc/tasks/panda/blocks_hard/blocks_hard.h"
...
std::string BlocksHard::XmlPath() const {
  return GetModelPath("panda/blocks_hard/task.xml");
}
std::string BlocksHard::Name() const { return "Panda Blocks Hard"; }
...
//     Residual (4): control
// ------------------------------------------------------------
void BlocksHard::ResidualFn::Residual(const mjModel* model, const mjData* data,
...
void BlocksHard::TransitionLocked(mjModel* model, mjData* data) {
